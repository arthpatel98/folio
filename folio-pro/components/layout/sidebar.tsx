...
import { BriefcaseBusiness, Check, ChevronDown, Coins, LayoutDashboard, Landmark, Layers3, Target } from "lucide-react";
import { cn } from "@/lib/utils";
import { portfolios, useActivePortfolio } from "@/components/portfolio/portfolio-context";

const items=[['/','Overview',LayoutDashboard],['/holdings','Holdings',BriefcaseBusiness],['/dca','Position Simulator',Coins],['/targets','Target Planner',Target],['/realized','Realized P/L',Landmark]] as const;
