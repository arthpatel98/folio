...
const items=[['/','Overview',LayoutDashboard],['/holdings','Holdings',BriefcaseBusiness],['/dca','DCA Calculator',Coins],['/targets','Target Planner',Target],['/realized','Realized P/L',Landmark],['/analytics','Analytics',BarChart3]] as const;
